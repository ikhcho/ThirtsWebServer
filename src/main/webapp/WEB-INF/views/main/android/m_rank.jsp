								...
								<div class="pull-right">
									<div class="btn-group">
										...
										<ul class="dropdown-menu pull-right" role="menu">
											<li><a href="m_rank?location=thirts">THIRTS 리조트</a></li>
								...
								<div class="panel-heading">
									...
									<div class="pull-right">
										<div class="btn-group">
											...
											<ul class="dropdown-menu pull-right" role="menu">
												<li><a href="m_rank?location=thirts&type=max">최고속도</a></li>
												<li><a href="m_rank?location=thirts&type=average">평균속도</a></li>
												<li><a href="m_rank?location=thirts&type=score">평점</a></li>
