	...
	<div id="wrapper">
		...
		<nav class="navbar navbar-default navbar-static-top" role="navigation"
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index">T H I R T S</a>
			...
			<div class="navbar-default sidebar" role="navigation">
				<div class="sidebar-nav navbar-collapse">
					<ul class="nav" id="side-menu">
						...
						<li><a href="index"><i class="fa fa-dashboard fa-fw"></i>Home</a></li>
		...
		<div id="page-wrapper">
			<div class="row">
				<div class="col-lg-12">
					<h1 class="page-header">조익현님</h1><!-- 이름 -->
				</div>
				<!-- /.col-lg-12 -->
			</div>
			<!-- /.row -->
			...
			<div class="row">
						...
						<div class="panel-heading">
							<div class="row">
								...
								<div class="col-xs-9 text-right">
									<div class="huge">26</div><!-- 옷장가기 -->
									<div><a href="#" style="color:white">새로운 기록</a></div>
								</div>
							</div>
						</div>
						<a href="#"><!-- 옷장이동 -->
							<div class="panel-footer">
								<span class="pull-left">최근기록</span> <span
						...
						<div class="panel-heading">
							<div class="row">
								...
								<div class="col-xs-9 text-right">
									...
									<div><a href="#" style="color:white">????</a></div>
								</div>
							</div>
						</div>
						<a href="#">
							<div class="panel-footer">
								<span class="pull-left">전체기록</span> <span
									class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
								<div class="clearfix"></div>
							</div>
						</a>
				...
				<div class="col-lg-3 col-md-6">
					<div class="panel panel-yellow">
						...
						<a href="#">
							<div class="panel-footer">
								<span class="pull-left">랭킹보기</span> <span
									class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
								<div class="clearfix"></div>
							</div>
						</a>
						...
						<div class="panel-heading">
							<div class="row">
								...
								<div class="col-xs-9 text-right">
									...
									<div><a href="#" style="color:white">새로운 동영상</a></div>
								</div>
							</div>
						</div>
						<a href="#">
							<div class="panel-footer">
								<span class="pull-left">커뮤니티</span> <span
									class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
								<div class="clearfix"></div>
							</div>
						</a>
